...
class StorageRepository(Protocol):
    ...
    def create_paper_account(self, account_id: str, payload: dict) -> None: ...
    def paper_account(self, account_id: str) -> dict | None: ...
    @contextmanager
    def paper_account_transaction(self, account_id: str) -> Iterator[dict]: ...
    def save_paper_record(self, record_id: str, account_id: str, kind: str, available_at: str, payload: dict) -> None: ...
    def paper_record(self, record_id: str) -> dict | None: ...
    def paper_records(self, account_id: str, kind: str, *, as_of: str, limit: int = 400) -> list[dict]: ...
